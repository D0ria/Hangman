Xavier Lavayssière bio photo Par Xavier Lavayssière 31 Mar 2020
Tweet   Share
...
L’instruction tentatives = tentatives - 1 peut paraître étonnante de premier abord, mais il suffit de comprendre l’ordre dans lequel le programme résout les opérations:
    ...
    Le programme calcule de le résultat de la soustraction tentatives - 1, il s’agit de la valeur contenue dans la variable tentatives, à laquelle on retire 1.
    Ce résultat est affecté à la variable tentatives
